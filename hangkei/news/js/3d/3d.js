...
function handleClick(objName) {
  switch (objName) {
    case 'btnBaymax':
      ...
      break;
    case 'btnNews1':
      window.location.href = "https://mp.weixin.qq.com/s/s9H3aLRWj6klvuc_s2STJw";
      break;
    case 'btnNews2':
      window.location.href = "https://mp.weixin.qq.com/s/Z8Axo7jmLEiMetVJceZUug";
      break;
    case 'btnNews3':
      window.location.href = "https://mp.weixin.qq.com/s/lw-_2fd5Esi-h-IvA_q-0A";
      break;
    default:
